      ...
      <button 
        ...
        onClick={() => switchImageHandler(false)}>
            <svg width="77" height="77" viewBox="0 0 77 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M38.5007 70.5833C56.2107 70.5833 70.584 56.2099 70.584 38.4999C70.584 20.7899 56.2107 6.41659 38.5007 6.41659C20.7907 6.41659 6.41732 20.7899 6.41732 38.4999C6.41732 56.2099 20.7907 70.5833 38.5007 70.5833ZM42.3507 25.9876L27.3677 37.2168C26.5015 37.8584 26.5015 39.1418 27.3677 39.7834L42.3507 51.0126C43.4094 51.8147 44.9173 51.0447 44.9173 49.7293V27.2709C44.9173 25.9555 43.4094 25.1855 42.3507 25.9876ZM64.1673 38.4999C64.1673 24.3512 52.6494 12.8333 38.5007 12.8333C24.3519 12.8333 12.834 24.3512 12.834 38.4999C12.834 52.6487 24.3519 64.1666 38.5007 64.1666C52.6494 64.1666 64.1673 52.6487 64.1673 38.4999Z" fill="white"/>
            </svg>
      </button>
